...
public class PutCubeHighCommandGroup extends SequentialCommandGroup {
    public PutCubeHighCommandGroup(IntakeCommand constantIntake, WristSetAngleCommandNoCANCoder wristMidPoint,

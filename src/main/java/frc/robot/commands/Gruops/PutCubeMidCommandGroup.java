...
public class PutCubeMidCommandGroup extends SequentialCommandGroup{
    public PutCubeMidCommandGroup(IntakeCommand constantIntake, WristSetAngleCommandNoCANCoder wristMidPoint,

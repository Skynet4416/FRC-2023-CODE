...
public class RobotContainer {
        ...
        private final Command m_autoBalacne = new AutoBalanceCommand(m_driveSubsystem,false);
        ...
        private void configureSmartDashboard() {
                ...
                m_chooser.addOption("Cone Substation",
                                m_autoManager.getCommand(GamePice.CONE,
                                                StartingPosition.IN_FRONT_OF_SINGLE_SUBSTATION));
                m_chooser.addOption("Cube Substation",
                                m_autoManager.getCommand(GamePice.CUBE,
                                                StartingPosition.IN_FRONT_OF_SINGLE_SUBSTATION));
        ...
        private void configureBindings() {
                ...
                // oi.Y.onTrue(m_restingCommand);
                oi.A.whileTrue(m_PutConeOrCubeLow);
                oi.RightBumper.onFalse(m_restingCommand);
                oi.Y.onFalse(m_restingCommand);
                oi.X.onFalse(m_restingCommand);
                oi.B.onFalse(m_restingCommand);
                oi.A.onFalse(m_restingCommand);
                oi.X.whileTrue(m_putCubeMidCommand);
                oi.B.whileTrue(m_putConeMid);
                oi.Y.whileTrue(m_putCubeHigh);
                // oi.RightBumper.whileTrue(new InstantCommand(() ->
                // m_LEDSubsystem.setColor(ColorEnum.YELLOW), m_LEDSubsystem));
                // oi.LeftBumper.whileTrue(new InstantCommand(() ->
                // m_LEDSubsystem.setColor(ColorEnum.PERPULE), m_LEDSubsystem));
                oi.RightBumper.whileTrue(m_IntakeSingleSubstationCommandGroup);
                ...
                oi.LeftBumper.whileTrue(m_autoBalacne);
        ...
        public Command getAutonomousCommand() throws IOException {
                ...
                // return m_autoManager.getCommand(GamePice.NONE, StartingPosition.IN_FRONT_OF_CABLE_GAURD);
        }
        ...
        public void SetColor(){
                m_LEDSubsystem.setColor(DriverStation.getAlliance() == Alliance.Blue ? ColorEnum.BLUE : ColorEnum.RED);
        }
